...
class G1TeleopEnvCfg(DirectRLEnvCfg):
    ...
    torque_penalty_weight = 1.0e-5
    torque_limit_penalty_weight = 5.0e-2
    ...
    body_velocity_sigma = 2.0
    foot_orientation_sigma = 8.0
    foot_air_time_height_threshold = 0.04
    foot_air_time_min_duration = 0.08
