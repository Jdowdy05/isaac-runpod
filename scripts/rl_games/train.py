...
def parse_args() -> tuple[argparse.Namespace, list[str]]:
    parser = argparse.ArgumentParser(description="Wrapper around Isaac Lab RL Games training.")
...
def main() -> None:
    ...
    if not train_script.exists():
        raise FileNotFoundError(f"Could not find Isaac Lab RL Games train script: {train_script}")
